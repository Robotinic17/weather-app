...
const conditon = document.querySelector(".conditon-txt");
...
const apiKeys = "d3eb8884e994cab80658476156ec1766";
...
// When Enter is pressed inside the input
cityInput.addEventListener("keydown", (event) => {
  if (event.key === "Enter" && cityInput.value.trim() != "") {
    updateWeatherInfo(cityInput.value);
    cityInput.value = "";
    cityInput.blur();
    event.preventDefault(); // stops accidental form submit/page reload
  }
});
